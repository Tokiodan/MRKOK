...
public class SpellUnlockUIJustin : MonoBehaviour
{
    ...
    public ExperienceManager experienceManager;  // Reference to the ExperienceManager
    ...
    void GenerateSpellButtons()
    {
        ...
        foreach (var mapping in spellManager.spellMappings)
        {
            ...
            int playerLevel = ExperienceManager.currentLevel; // Get the player's current level from ExperienceManager
    ...
    {
        spellManager.UnlockSpell(spellID, ExperienceManager.currentLevel); // Get current level from ExperienceManager
